...
interface CrossSellListItemProps {
...
export const CrossSellListItem = memo(
	({
		item,
		colors,
		onPress,
		...
		onAdd = () => {},
		role,
	}: CrossSellListItemProps) => {
		const hasImage = item.imageUrl && item.imageUrl.trim() !== "";

		// 💰 Si hay un precio de sobreescritura lo usamos, si no, el normal
		...
		return (
			<TouchableOpacity
				...
				onPress={onPress}
			>
				{/* 📝 Información del Producto Cruzado (Izquierda) */}
